...
_PRIVATE_CPU_INCLUDE_COPTS_LIST = [
    "-iquote",
    "external/onednn_cpu_eigen/src/cpu",
    "-iquote",
    "external/onednn_cpu_eigen/src/cpu/gemm",
]

_PRIVATE_GPU_PROVIDER_INCLUDE_COPTS_LIST = [
    "-iquote",
    "external/onednn_cpu_eigen/src/gpu/intel/jit/config",
    "-iquote",
    "external/onednn_cpu_eigen/src/gpu/intel/gemm/jit",
    "-iquote",
    "external/onednn_cpu_eigen/src/gpu/intel/gemm/jit/include",
    "-iquote",
    "external/onednn_cpu_eigen/src/gpu/intel/gemm/jit/include/gemmstone",
    "-iquote",
    "external/onednn_cpu_eigen/src/gpu/intel/microkernels",
    "-iquote",
    "external/onednn_cpu_eigen/third_party/ngen",
]
